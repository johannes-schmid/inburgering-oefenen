/**
 * The tijdlijn-maker: work out your own inburgering deadlines from the date on your PIP.
 *
...
const HREF = '/inburgering/tools/tijdlijn' as const;
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: 'planned.tijdlijn' });
  return {
    title: t('meta_title'),
