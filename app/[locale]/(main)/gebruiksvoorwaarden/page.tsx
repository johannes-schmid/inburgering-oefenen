  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 pb-24">
      ...
      >
        ...
        <p>Inburgering Oefenen is een online platform voor de <strong>inburgering in Nederland</strong>. Het biedt oefenexamens voor de vier taalonderdelen — Lezen, Luisteren, Schrijven en Spreken — en kennisgidsen en hulpmiddelen over het hele traject, waaronder KNM en ONA. De oefenexamens zijn beschikbaar op niveau A2 en op niveau B1, en voor KNM (dat geen taalniveau kent). Luisteren op B1 is nog niet beschikbaar. Het platform biedt een gratis gedeelte — een korte oefenset per onderdeel en het eerste oefenexamen van elk onderdeel met een account — en <strong>betaalde maandabonnementen per onderdeel</strong> voor de overige oefenexamens. De inhoud wordt samengesteld en gecontroleerd door een gecertificeerde NT2-docent.</p>
